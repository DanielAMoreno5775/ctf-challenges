...
def generate_keypair(bits=1024):      
    p = 114043922193032545905195666699056488519839553952179968589645935591582172803271
    q = 87178981589061421206670326414930917287826776386361842556997599308105910234621
    n = p * q
    phi = (p - 1) * (q - 1)
